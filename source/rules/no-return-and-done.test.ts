    ...
    invalid: [
        {
            ...
            errors: [ { message, column: 30, line: 1, endLine: 1, endColumn: 52 } ]
        },
        {
            code: 'it("title", function(done) { return foo.then(function() { done(); }).catch(done); });',
            errors: [ { message, column: 30, line: 1, endLine: 1, endColumn: 82 } ]
        },
        {
            code: 'it("title", function(done) { var foo = bar(); return foo.then(function() { done(); }); });',
            errors: [ { message, column: 47, line: 1, endLine: 1, endColumn: 87 } ]
        },
        {
            code: 'it("title", (done) => { return foo.then(function() { done(); }).catch(done); });',
            languageOptions: es6LanguageOptions,
            errors: [ { message, column: 25, line: 1, endLine: 1, endColumn: 77 } ]
        },
        {
        ...
        },
        {
            ...
            errors: [ { message, column: 35, line: 1, endLine: 1, endColumn: 57 } ]
        },
        {
            code: 'before("title", function(done) { return foo.then(done); });',
            errors: [ { message, column: 34, line: 1, endLine: 1, endColumn: 56 } ]
        },
        {
            code: 'beforeEach("title", function(done) { return foo.then(done); });',
            errors: [ { message, column: 38, line: 1, endLine: 1, endColumn: 60 } ]
        },
        {
            code: 'after("title", function(done) { return foo.then(done); });',
            errors: [ { message, column: 33, line: 1, endLine: 1, endColumn: 55 } ]
        },
        {
            code: 'afterEach("title", function(done) { return foo.then(done); });',
            errors: [ { message, column: 37, line: 1, endLine: 1, endColumn: 59 } ]
        },
        {
            code: 'afterEach("title", function(done) { return foo; });',
            errors: [ { message, column: 37, line: 1, endLine: 1, endColumn: 48 } ]
        },
        {
            code: 'afterEach("title", function(done) { return done; });',
            errors: [ { message, column: 37, line: 1, endLine: 1, endColumn: 49 } ]
        },
        {
            code: 'afterEach("title", function(done) { return done.foo(); });',
            errors: [ { message, column: 37, line: 1, endLine: 1, endColumn: 55 } ]
        },
        {
        ...
        },
        {
            ...
            errors: [ { message, column: 36, line: 1, endLine: 1, endColumn: 50 } ]
        }
    ]
});
