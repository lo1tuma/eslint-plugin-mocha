...
export type CustomNameConfig = Pick<NameDetailsConfig, 'type' | 'interface'> & { name: string; };

function nameConfigToNameDetails(nameConfig: CustomNameConfig): NameDetailsConfig {
