...
function findCalls(
    ...
    names: readonly Partial<NameDetails>[],
    {
        ...
        interfaceToUse?: 'BDD' | 'require' | 'TDD';
...
describe('findMochaVariableCalls()', function () {
    ...
    it('finds require-interface custom names via imports', function () {
        const calls = findCalls(
    ...
    it('does not treat global-interface custom names as require imports', function () {
        const calls = findCalls(
            'import { foo } from "bar"; foo();',
