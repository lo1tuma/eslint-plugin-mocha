## eslint-plugin-mocha 12.0.3 (August 22, 2026)

### Dependency Upgrades

* ⬆️ Update dependency @packtory/cli to v0.0.97 ([#609](https://github.com/lo1tuma/eslint-plugin-mocha/pull/609))
* ⬆️ Update dependency @packtory/cli to v0.0.96 ([#608](https://github.com/lo1tuma/eslint-plugin-mocha/pull/608))
* ⬆️ Update dependency jscpd to v5.0.16 ([#607](https://github.com/lo1tuma/eslint-plugin-mocha/pull/607))
* ⬆️ Update dependency @packtory/cli to v0.0.94 ([#606](https://github.com/lo1tuma/eslint-plugin-mocha/pull/606))
* ⬆️ Update dependency @packtory/cli to v0.0.93 ([#604](https://github.com/lo1tuma/eslint-plugin-mocha/pull/604))
* ⬆️ Update Linting-related dependencies ([#603](https://github.com/lo1tuma/eslint-plugin-mocha/pull/603), [#598](https://github.com/lo1tuma/eslint-plugin-mocha/pull/598), [#595](https://github.com/lo1tuma/eslint-plugin-mocha/pull/595), [#584](https://github.com/lo1tuma/eslint-plugin-mocha/pull/584))
* ⬆️ Update dependency @packtory/cli to v0.0.92 ([#602](https://github.com/lo1tuma/eslint-plugin-mocha/pull/602))
* ⬆️ Update stryker-js monorepo to v10 ([#601](https://github.com/lo1tuma/eslint-plugin-mocha/pull/601))
* ⬆️ Update dependency @packtory/cli to v0.0.91 ([#599](https://github.com/lo1tuma/eslint-plugin-mocha/pull/599))
* ⬆️ Update dependency jscpd to v5.0.15 ([#596](https://github.com/lo1tuma/eslint-plugin-mocha/pull/596))
* ⬆️ Update dependency @packtory/cli to v0.0.89 ([#594](https://github.com/lo1tuma/eslint-plugin-mocha/pull/594))
* ⬆️ Update dependency @packtory/cli to v0.0.88 ([#590](https://github.com/lo1tuma/eslint-plugin-mocha/pull/590))
* ⬆️ Update dependency knip to v6.32.2 ([#591](https://github.com/lo1tuma/eslint-plugin-mocha/pull/591))
* ⬆️ Update dependency dependency-cruiser to v18.2.0 ([#589](https://github.com/lo1tuma/eslint-plugin-mocha/pull/589))
* ⬆️ Update dependency @typescript-eslint/parser to v8.67.0 ([#587](https://github.com/lo1tuma/eslint-plugin-mocha/pull/587))
* ⬆️ Update dependency knip to v6.32.1 ([#586](https://github.com/lo1tuma/eslint-plugin-mocha/pull/586))
* ⬆️ Update dependency @packtory/cli to v0.0.86 ([#585](https://github.com/lo1tuma/eslint-plugin-mocha/pull/585))
* ⬆️ Update dependency @packtory/cli to v0.0.84 ([#582](https://github.com/lo1tuma/eslint-plugin-mocha/pull/582))
* Update dependency eslint to v10.8.1 ([#581](https://github.com/lo1tuma/eslint-plugin-mocha/pull/581))
* Update dependency @packtory/cli to v0.0.82 ([#580](https://github.com/lo1tuma/eslint-plugin-mocha/pull/580))
* Update dependency knip to v6.32.0 ([#578](https://github.com/lo1tuma/eslint-plugin-mocha/pull/578))
* Update dependency @packtory/cli to v0.0.81 ([#577](https://github.com/lo1tuma/eslint-plugin-mocha/pull/577))
* Update dependency @typescript-eslint/parser to v8.66.0 ([#576](https://github.com/lo1tuma/eslint-plugin-mocha/pull/576))
* Update Linting-related dependencies ([#573](https://github.com/lo1tuma/eslint-plugin-mocha/pull/573))
* Update dependency @packtory/cli to v0.0.80 ([#574](https://github.com/lo1tuma/eslint-plugin-mocha/pull/574))
* Update dependency mocha to v11.8.0 ([#571](https://github.com/lo1tuma/eslint-plugin-mocha/pull/571))
* Update dependency dependency-cruiser to v18.1.1 ([#570](https://github.com/lo1tuma/eslint-plugin-mocha/pull/570))
* Update dependency knip to v6.31.0 ([#565](https://github.com/lo1tuma/eslint-plugin-mocha/pull/565))
...
* Fix no-sibling-hooks nested function false positives ([#439](https://github.com/lo1tuma/eslint-plugin-mocha/pull/439))
...
* Update dependency @eslint-community/eslint-utils to v4.10.1 ([#544](https://github.com/lo1tuma/eslint-plugin-mocha/pull/544))
* Update dependency @eslint-community/eslint-utils to v4.10.0 ([#543](https://github.com/lo1tuma/eslint-plugin-mocha/pull/543))
